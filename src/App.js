    ...
    <BrowserRouter>
      <Layout>
        <Routes>
          ...
          <Route
            path="/feedback"
            element={tok ? <FeedbackPage /> : <AdminLogin />}
          />
          <Route path="/help" element={tok ? <HelpPage /> : <AdminLogin />} />
          <Route
            path="/history"
            element={tok ? <HistoryPage /> : <AdminLogin />}
          />
          <Route
            path="/location"
            element={tok ? <LocationPage /> : <AdminLogin />}
          />
          <Route
            path="/report"
            element={tok ? <ReportPage /> : <AdminLogin />}
          />
          <Route
            path="/scooter"
            element={tok ? <ScooterPage /> : <AdminLogin />}
          />
          <Route
            path="/settings"
            element={tok ? <SettingPage /> : <AdminLogin />}
          />
