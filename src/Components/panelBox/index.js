...
const PanelBox = () => {
  return (
    <div className="flex min-[200px]:flex-col md:flex-row  mx-5  items-center  ">
      {data.map((item, index) => (
        <div
          key={index}
          className="border  border-gray-200 p-2 lg:h-[150px] md:h-[140px] xl:h-[160px] xl:w-[12rem] xl:mx-6  lg:w-[50%] m-2 w-[90%] md:w-[25%]"
        >
